...
import routeValidationRouter from './routes/routeValidation.js';
...
// Use validateLocations as a route handler
app.use('/api', routeValidationRouter);

// Default route for testing
app.get('/', (req, res) => {
    res.send('RideOK Backend Running');
});
