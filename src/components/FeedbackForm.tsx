            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="block w-full px-4 py-2 border border-gray-300 rounded-md text-gray-800 bg-white focus:border-blue-500 focus:ring-blue-500"
    required   placeholder="Enter your name" // Added placeholder for better UX
                />
              </div>
